...
$scf_value_name     = isset($_POST['scf_name'])     ? sanitize_text_field($_POST['scf_name'])        : '';
...
$scf_value_subject  = isset($_POST['scf_subject'])  ? sanitize_text_field($_POST['scf_subject'])     : '';
$scf_value_response = isset($_POST['scf_response']) ? sanitize_text_field($_POST['scf_response'])    : '';
$scf_value_message  = isset($_POST['scf_message'])  ? sanitize_text_field($_POST['scf_message']) : '';

$scf_strings = array(
	'name' 	   => '<input name="scf_name" id="scf_name" type="text" size="33" maxlength="99" value="'. esc_attr( $scf_value_name ) .'" placeholder="' . $scf_options['scf_input_name'] . '" />',
    'email'    => '<input name="scf_email" id="scf_email" type="text" size="33" maxlength="99" value="'. esc_attr( $scf_value_email ) .'" placeholder="' . $scf_options['scf_input_email'] . '" />',
    'confirm_email' => '<input name="scf_confirm_email" id="scf_confirm_email" type="text" size="33" maxlength="99" value="'. esc_attr( $scf_value_confirm_email ) .'" placeholder="' . $scf_options['scf_input_confirm_email'] . '" />',
	'subject'  => '<input name="scf_subject" id="scf_subject" type="text" size="33" maxlength="99" value="'. esc_attr( $scf_value_subject ) .'" placeholder="' . $scf_options['scf_input_subject'] . '" />',
	'response' => '<input name="scf_response" id="scf_response" type="text" size="33" maxlength="99" value="'. esc_attr( $scf_value_response ) .'" placeholder="' . $scf_options['scf_input_captcha'] . '" />',
...
function scf_process_contact_form() {
    ...
    $topic   = (isset($_POST['scf_subject']) && !empty($_POST['scf_subject'])) ? sanitize_text_field( stripslashes(strip_tags(trim($_POST['scf_subject'])))) : $subject;    
	$topic = strip_shortcodes( $topic );
	$topic = str_replace( '[simple_contact_form_date]', current_time( get_option( 'date_format' ) ), $topic );

	$name    = isset($_POST['scf_name']) ? sanitize_text_field( stripslashes(strip_tags(trim($_POST['scf_name']))) ) : '';
	$name = strip_shortcodes( $name );
	$topic = str_replace( '{name}', $name, $topic );

	$message = isset($_POST['scf_message']) ? sanitize_text_field( stripslashes(trim($_POST['scf_message'])) ) : '';
	$message = strip_shortcodes( $message );

	$email   = isset($_POST['scf_email']) ? sanitize_text_field($_POST['scf_email']) : '';
	$email = strip_shortcodes( $email );
...
function scf_render_form() {
	...
	<div id="mm-plugin-options" class="wrap">
		...
		<h1><?php echo esc_html( $scf_plugin ); ?> <small><?php echo 'v'. esc_html( $scf_version ); ?></small></h1>
		...
		<form method="post" action="options.php">
					...
					<div id="mm-panel-overview" class="postbox">
						...
						<div class="toggle<?php if (isset($_GET["settings-updated"])) { echo ' default-hidden'; } ?>">
							<div class="mm-panel-overview">
								<p>
									<strong><?php echo esc_html( $scf_plugin ); ?></strong> <?php esc_html_e('is a secure contact form that&rsquo;s fast and flexible.', 'scf'); ?>
							...
							<div class="mm-table-wrap">
								<table class="widefat mm-table">
									<tr>
										...
										<td><input type="text" class="regular-text" size="50" maxlength="200" name="scf_options[scf_name]" value="<?php echo esc_attr( $scf_options['scf_name'] ); ?>" />
									...
									<tr>
										...
										<td><input type="text" class="regular-text" size="50" maxlength="200" name="scf_options[scf_email]" value="<?php echo esc_attr( $scf_options['scf_email'] ); ?>" />
									...
									<tr>
										...
										<td><input type="text" size="50" maxlength="200" name="scf_options[scf_from]" value="<?php echo esc_attr( $scf_options['scf_from'] ); ?>" />
									...
									<tr>
										...
										<td><input type="text" class="regular-text" size="50" maxlength="200" name="scf_options[scf_website]" value="<?php echo esc_attr( $scf_options['scf_website'] ); ?>" />
									...
									<tr>
										...
										<td><input type="text" class="regular-text" size="50" maxlength="200" name="scf_options[scf_subject]" value="<?php echo esc_attr( $scf_options['scf_subject'] ); ?>" />
							...
							<div class="mm-table-wrap">
								<table class="widefat mm-table">
									...
									<tr>
										...
										<td><input type="text" class="regular-text" size="50" maxlength="200" name="scf_options[scf_question]" value="<?php echo esc_attr( $scf_options['scf_question'] ); ?>" />
									...
									<tr>
										...
										<td><input type="text" class="regular-text" size="50" maxlength="200" name="scf_options[scf_response]" value="<?php echo esc_attr( $scf_options['scf_response'] ); ?>" />
									...
									<tr>
										...
										<td><input type="text" class="regular-text" size="50" maxlength="200" name="scf_options[scf_recaptcha_site_key]" value="<?php echo esc_attr( $scf_options['scf_recaptcha_site_key'] ); ?>" />
									...
									<tr>
										...
										<td><input type="text" class="regular-text" size="50" maxlength="200" name="scf_options[scf_recaptcha_secret_key]" value="<?php echo esc_attr( $scf_options['scf_recaptcha_secret_key'] ); ?>" />
							...
							<div class="mm-table-wrap">
								<table class="widefat mm-table">
									<tr>
										...
										<td><input type="text" class="regular-text" size="50" maxlength="200" name="scf_options[scf_nametext]" value="<?php echo esc_attr( $scf_options['scf_nametext'] ); ?>" />
									...
									<tr>
										...
										<td><input type="text" class="regular-text" size="50" maxlength="200" name="scf_options[scf_input_name]" value="<?php echo esc_attr( $scf_options['scf_input_name'] ); ?>" />
									...
									<tr>
										...
										<td><input type="text" class="regular-text" size="50" maxlength="200" name="scf_options[scf_mailtext]" value="<?php echo esc_attr( $scf_options['scf_mailtext'] ); ?>" />
									...
									<tr>
										...
										<td><input type="text" class="regular-text" size="50" maxlength="200" name="scf_options[scf_input_email]" value="<?php echo esc_attr( $scf_options['scf_input_email'] ); ?>" />
                                    ...
                                    <tr>
										...
										<td><input type="text" class="regular-text" size="50" maxlength="200" name="scf_options[scf_confirm_mailtext]" value="<?php echo esc_attr( $scf_options['scf_confirm_mailtext'] ); ?>" />
                                    ...
                                    <tr>
										...
										<td><input type="text" class="regular-text" size="50" maxlength="200" name="scf_options[scf_input_confirm_email]" value="<?php echo esc_attr( $scf_options['scf_input_confirm_email'] ); ?>" />
									...
									<tr>
										...
										<td><input type="text" class="regular-text" size="50" maxlength="200" name="scf_options[scf_subjtext]" value="<?php echo esc_attr( $scf_options['scf_subjtext'] ); ?>" />
									...
									<tr>
										...
										<td><input type="text" class="regular-text" size="50" maxlength="200" name="scf_options[scf_input_subject]" value="<?php echo esc_attr( $scf_options['scf_input_subject'] ); ?>" />
									...
									<tr>
										...
										<td><input type="text" class="regular-text" size="50" maxlength="200" name="scf_options[scf_messtext]" value="<?php echo esc_attr( $scf_options['scf_messtext'] ); ?>" />
									...
									<tr>
										...
										<td><input type="text" class="regular-text" size="50" maxlength="200" name="scf_options[scf_submittext]" value="<?php echo esc_attr( $scf_options['scf_submittext'] ); ?>" />
									...
									<tr>
										...
										<td><input type="text" class="regular-text" size="50" maxlength="200" name="scf_options[scf_input_message]" value="<?php echo esc_attr( $scf_options['scf_input_message'] ); ?>" />
									...
									<tr>
										...
										<td><input type="text" class="regular-text" size="50" maxlength="200" name="scf_options[scf_input_captcha]" value="<?php echo esc_attr( $scf_options['scf_input_captcha'] ); ?>" />
			...
			<div id="mm-credit-info">
				<a target="_blank" href="<?php echo esc_url( $scf_homeurl ); ?>" title="<?php esc_attr_e('Plugin Homepage', 'scf'); ?>"><?php echo esc_html( $scf_plugin ); ?></a> <?php esc_html_e('by', 'scf'); ?>
...
function scf_confirm_checkbox() {
	...
	<div class="scf-confirm-checkbox">
		<label><input type="checkbox" required> <?php echo wp_kses_post( $scf_options['scf_gdpr_message'] ); ?></label>
...
function scf_get_field_value( $name ) {
	...
	$message = isset($_POST[$name]) ? sanitize_text_field( stripslashes(trim($_POST[$name]))) : '';
	return $message;
