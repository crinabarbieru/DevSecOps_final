(function($) {
    ...
    var wpsdColorPicker = ['#wpsd_form_border_color', '#wpsd_form_bg_color', '#wpsd_form_input_border_color', '#wpsd_form_input_bg_color', '#wpsd_form_input_font_color',
        ...
        '#wpsd_form_amount_bg_color',
        '#wpsd_form_amount_border_color',
        '#wpsd_form_amount_font_color',
        '#wpsd_form_amount_bg_color_hvr',
        '#wpsd_form_amount_border_color_hvr',
        '#wpsd_form_amount_font_color_hvr'
    ];
